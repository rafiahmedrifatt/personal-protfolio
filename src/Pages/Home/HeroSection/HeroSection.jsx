                ...
                >
                    ...
                    >
                        <p className='text-base sm:text-lg leading-relaxed' style={{ color: '#94A3B8' }}>
                            I'm a <span className="font-semibold" style={{ color: '#A78BFA' }}>MERN stack developer</span> fueled by curiosity and a passion for clean, purposeful code.
                        ...
                        <p className='text-base sm:text-lg leading-relaxed mt-3 sm:mt-4' style={{ color: '#94A3B8' }}>
                            Always building, always learning — because <span className="italic font-medium" style={{ color: '#818CF8' }}>good enough is never enough.</span>
                        </p>
                    </motion.div>
